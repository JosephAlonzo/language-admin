<template>
    ...
    <v-toolbar-title>Holi</v-toolbar-title>
    <v-spacer></v-spacer>
    ...
    <v-menu
      ...
      nudge-bottom="10">
        ...
        <v-list >
          <div class="text-h5 grey--text text--darken-3 px-4 pt-4">{{user.displayName}}</div>
          <v-list-item-group color="primary">
            <v-list-item
  ...
  export default {
    ...
    data: () => ({
      ...
      notifications: [
        ...
        { text: 'Nouveau étudiant enregistré', icon: 'mdi-thumb-up', color: 'success'  },
