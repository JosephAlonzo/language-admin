    ...
    <v-row class="pt-5 pb-2">
      <v-col cols="12" align="center">
        <v-img
          ...
          class="mb-2"
        ></v-img>
        <p class="pt-2 mb-1 grey--text" v-if="user != undefined">{{user.currentUser.displayName}}</p>
      </v-col>
...
import {mapActions, mapState} from 'vuex'
  ...
  export default {
    ...
    data(){
      return {
        items: [
          { title: 'Tableau de bord', icon: 'mdi-view-quilt', link: '/home' },
          { title: 'Mes projets', icon: ' mdi-cards', link: '/projets' },
          { title: 'Vocabulaire', icon: 'mdi-tooltip-image', link: '/vocabulaire' },
